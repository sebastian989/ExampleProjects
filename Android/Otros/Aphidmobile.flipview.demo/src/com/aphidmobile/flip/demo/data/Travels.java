...
public class Travels {
  ...
  static {
    ...
    Travels.IMG_DESCRIPTIONS.add(new Travels.Data("Manizales", "drepung_monastery.jpg",
            									  "<b>Manizales city</b> is the second largest city of Nepal with approximately 250,000 inhabitants and is situated about 200 km west of the capital Kathmandu.",
            									  "Nepal", "Pokhara",
            									  "http://en.wikipedia.org/wiki/Pokhara"));
  }
